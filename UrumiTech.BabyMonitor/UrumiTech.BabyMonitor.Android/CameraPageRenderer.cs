...
using UrumiTech.BabyMonitor.Droid;
using UrumiTech.BabyMonitor.Views;

[assembly: ExportRenderer(typeof(CameraPage), typeof(CameraPageRenderer))]

namespace UrumiTech.BabyMonitor.Droid
{
    public class CameraPageRenderer : PageRenderer, TextureView.ISurfaceTextureListener
    {
        ...
        void SetupEventHandlers()
        {
            ...
            if (takePhotoButton != null) takePhotoButton.Click += TakePhotoButtonTapped;

            switchCameraButton = view.FindViewById<global::Android.Widget.Button>(Resource.Id.switchCameraButton);
            if (switchCameraButton != null) switchCameraButton.Click += SwitchCameraButtonTapped;

            toggleFlashButton = view.FindViewById<global::Android.Widget.Button>(Resource.Id.toggleFlashButton);
            if (toggleFlashButton != null) toggleFlashButton.Click += ToggleFlashButtonTapped;
        }
